...
let EmailController = class EmailController {
    ...
    async fetchEmailById(id, folder) {
...
], EmailController.prototype, "listFolders", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.EmailFilterDto]),
    __metadata("design:returntype", Promise)
], EmailController.prototype, "fetchEmails", null);
__decorate([
    (0, common_1.Get)('unread-with-pdf'),
    __param(0, (0, common_1.Query)('folder')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EmailController.prototype, "getUnreadWithPdf", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], EmailController.prototype, "fetchEmailById", null);
